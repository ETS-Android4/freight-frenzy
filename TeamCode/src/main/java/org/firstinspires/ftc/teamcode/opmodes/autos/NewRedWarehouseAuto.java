...
@Autonomous
public class NewRedWarehouseAuto extends RobotAuto{
    ...
    public static final Pose2d SECOND_COLLECT_POSE = new Pose2d(DIST_FROM_WALL + X_OFFSET, 104, Math.toRadians(105));
    ...
    public static final Pose2d FOURTH_COLLECT_POSE = new Pose2d(34, 107, Math.toRadians(110));
    public static final Pose2d FOURTH_GAP_OUTER_POSE = new Pose2d(34, 70, Math.toRadians(87));
    public static final Pose2d FOURTH_SCORE_POSE = new Pose2d(32, 69, Math.toRadians(43));

    public static final Pose2d FIFTH_COLLECT_POSE = new Pose2d(40, 107, Math.toRadians(110));
    public static final Pose2d FIFTH_GAP_OUTER_POSE = new Pose2d(40, 70, Math.toRadians(87));
    public static final Pose2d FIFTH_SCORE_POSE = new Pose2d(38, 69, Math.toRadians(43));
    ...
    public void runOpMode() throws InterruptedException {
        ...
        toCollect = RRdrive.trajectoryBuilder(GAP_OUTER_POSE)
                .lineToLinearHeading(COLLECT_POSE)
                .build();

        toSecondCollect = RRdrive.trajectoryBuilder(SECOND_GAP_OUTER_POSE)
                .lineToLinearHeading(SECOND_COLLECT_POSE)
                .build();

        toThirdCollect = RRdrive.trajectoryBuilder(THIRD_GAP_OUTER_POSE)

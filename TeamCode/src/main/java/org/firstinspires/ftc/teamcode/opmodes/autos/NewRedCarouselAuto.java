...
public class NewRedCarouselAuto extends RobotAuto {
    ...
    private static int EXTEND_TO_MID = 1575; //1550
    private static int EXTEND_TO_BOTTOM = 1510; //1510
    private static int STRAFE_TO_STORAGE = 400; //Formally 1200
    private static int TURN_TO_DUCK_SCORE = 85; //235
    private static int TURN_IN_STORAGE = 220; //Formally 140
    private static int TURN_TO_COLLECT_DUCK = 250;
    private static int STRAFE_IN_STORAGE = 425;
...
//gamer - Randall Delafuente
    ...
    public void runOpMode() throws InterruptedException {
        ...
        encoderDrive(0.0, 0, -0.5, TURN_TO_DUCK_SCORE);
        ...
        encoderDrive(0.0, 0.0, -0.5, TURN_IN_STORAGE);

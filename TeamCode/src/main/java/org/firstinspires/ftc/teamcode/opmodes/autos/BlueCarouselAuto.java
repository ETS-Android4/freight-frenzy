...
public class BlueCarouselAuto extends RobotAuto {
    ...
    private static int EXTEND_TO_MID = 2475;
    private static int EXTEND_TO_BOTTOM = 2400;
    private static int STRAFE_TO_STORAGE = 1650;
...
//gamer - Randall Delafuente
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (!opModeIsActive() && !isStopRequested()){
            telemetry.addData("Element Location: ", vision.getElementPipelineBlue().getLocation());
            telemetry.update();
        }
        ...
        elementLocation = vision.getElementPipelineBlue().getLocation();
